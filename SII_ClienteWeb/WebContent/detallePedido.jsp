    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
     ...
     srcset = "/APD_CTE_WEB/logochico.png 2x, 
        ...
        <h1 class="my-41">
         ...
         <% int cantidad = venta.getItems().size(); %>
            ...
            <table class="table table-bordered" id="dataTable" cellspacing="0">
              ...
              <%
				...
				if (venta.getItems() != null) {
					for (Iterator<ItemVentaDTO> i = venta.getItems().iterator(); i.hasNext();) {
						item = i.next();
						total += item.getArticulo().getPrecioUnitario();
						cant += 1;
				%>
              <tr>
                  <td><%=item.getArticulo().getIdArticulo().toString() %></td>
                  <td><%=item.getArticulo().getDescripcion() %></td>
                  <td><%=String.valueOf(item.getArticulo().getPrecioUnitario()) %></td>
                  <td>1</td>
