    ...
    <div class="container">
      ...
      <h1 class="my-4">iaPOS
        <small>Pago | Ingreso de cheque</small>
            ...
            <form action="/APD_CTE_WEB/servlets/ServletModuloVentas" method="post" id="procesarVenta">
            ...
            <tr>
            <td>
            <input type="hidden" name="action" value="procesarVenta">
            <input type="hidden" name="medioPago" value="cheque">
            <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#exampleModal">Cambiar medio de pago</a>

            <input type="submit" class="btn btn-primary" align=center name="procesarVenta" value="Confirmar">
            </td>
            </tr> 
